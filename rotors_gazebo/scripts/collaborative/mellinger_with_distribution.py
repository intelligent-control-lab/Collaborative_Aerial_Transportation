...
class MellingerWithDistributor(Mellinger):
    def __init__(self, mav_name, x, y, z, dim=3, index=0):
        Mellinger.__init__(self, mav_name, x, y, z, dimension=dim, N=10)
...
class CentralizedControllerDistributor(object):
    def __init__(self, name='controller'):
        ...
        self.name = name
        self.controllers = [
                      MellingerWithDistributor('hummingbird_0', 0.95, 0.0, 0.35, dim=dimension, index=0),
                      MellingerWithDistributor('hummingbird_1', 0.0, 0.95, 0.35, dim=dimension, index=1),
                      MellingerWithDistributor('hummingbird_2', -0.95, 0.0, 0.35, dim=dimension, index=2),
                      MellingerWithDistributor('hummingbird_3', 0.0, -0.95, 0.35, dim=dimension, index=3)
                      ]
        self.num_of_quads = 4
