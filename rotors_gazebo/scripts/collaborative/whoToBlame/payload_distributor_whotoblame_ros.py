...
class PayloadDistributor(object):
    def __init__(self, mav_name, c_initial, index):
        self.index = index
    ...
    def pre_processing(self, filename='/home/lucasyu/gazebo_learning_ws/src/collaborative_transportation/rotors_gazebo/scripts/collaborative/config/parameters.yaml'):
