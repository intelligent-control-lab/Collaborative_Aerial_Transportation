...
def p_train(make_obs_ph_n, act_space_n, p_index, p_func, q_func, optimizer, grad_norm_clipping=None, local_q_func=False, num_units=256, scope="trainer", reuse=None):
    with tf.variable_scope(scope, reuse=reuse):
        ...
        p = p_func(lstm_input=p_input, lstm_state_in=None, num_outputs=int(act_pdtype_n[p_index].param_shape()[0]), scope="p_func", num_units=num_units,LSTM_UNITS=32, timestep_lstm=8, init=1)
